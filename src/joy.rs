...
pub mod ll {
	...
	externfn!(fn SDL_JoystickName(i: c_int) -> *c_schar)
	externfn!(fn SDL_JoystickOpen(i: c_int) -> *SDL_Joystick)
	externfn!(fn SDL_JoystickOpened(i: c_int) -> c_int)
	externfn!(fn SDL_JoystickIndex(joystick: *SDL_Joystick) -> c_int)
	...
	externfn!(fn SDL_JoystickGetAxis(joystick: *SDL_Joystick, axis: c_int) -> int16_t)
	externfn!(fn SDL_JoystickGetHat(joystick: *SDL_Joystick, hat: c_int) -> uint8_t)
	externfn!(fn SDL_JoystickGetBall(joystick: *SDL_Joystick, ball: c_int, dx: *c_int, dy: *c_int)
			   -> c_int)
	externfn!(fn SDL_JoystickGetButton(joystick: *SDL_Joystick, button: c_int) -> uint8_t)
